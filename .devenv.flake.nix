{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/workspace/git/denvit-blog";
  project_input_ref = "path:/home/workspace/git/denvit-blog";
  devenv_dotfile = "/home/workspace/git/denvit-blog/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/tmp";
  devenv_runtime = "/tmp/devenv-7601c6a";
  devenv_istesting = false;
  devenv_direnvrc_latest_version = 1;
  container_name = null;
  active_profiles = [
  ];
  hostname = "workspace-denys-54bf466b75-mr9qt";
  username = "workspace";
  git_root = "/home/workspace/git/denvit-blog";
  secretspec = null;
};
    in
    {
